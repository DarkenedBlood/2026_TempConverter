...
class Converter:
    """
    Temperature conversion tool (°C to °F and °F to °C
    """
    ...
    def __init__(self):
        ...
        # button list (button name | bg colour | command | row | column)
        button_details_list = [
    ...
    def check_temp(self, min_temp):
        ...
        # checks that amount that needs to be converted is a number above absolute zero
        try:
    ...
    def to_help(self):
        """
        Opens help dialogue box and disables button
...
class DisplayHelp:
    ...
    def __init__(self, partner):
        ...
        help_text = ("To use the program, simply enter the temperature "
                     "you wish to convert and the choose to convert "
...
class DisplayHistory:
    ...
    def __init__(self, partner, calculations):
        ...
        # create sting from calculations list (newest calculations first)
        newest_first_string = ""
    ...
    def export_data(self, calculations):
        ...
        # edit label so that users know that their export has been done.
